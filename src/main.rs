...
fn main() {
    ...
    let repo = get_repo(matches.value_of("sqlite"), matches.values_of("airtable"));
...
fn get_repo(sqlite_value: Option<&str>, airtable_values: Option<Values>) -> Arc<dyn Repository> {
